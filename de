...
_base_ = [
    './cascade_mask_rcnn_sw_fpn.py',
    '../_base_/datasets/coco_instance.py',
    '../_base_/schedules/schedule_1x.py', '../_base_/default_runtime.py'
]

checkpoint_file = '/home/dtlab/autodl-tmp/pretrained/sw_tiny_in1k_224_acc83.39.pth'
dims = [80, 160, 320, 640]
...
evaluation = dict(save_best='auto',metric=['bbox', 'segm'], classwise=True)
